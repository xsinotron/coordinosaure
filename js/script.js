    ...
    var window   = this,
        ...
        ui = function () {
            ...
            this.buttons = function () {
                ...
                $('#add-new-amapien-button').click(function (ev) {
                    $.ajax({
                        dataType: 'html',
                        url: 'core.php?amapien=new',
                        success: function (popin) {
                            $('body').prepend(popin);
